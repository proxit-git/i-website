...
import { ArrowLeft, Eye, EyeOff, Mail, Lock, User, Phone, Briefcase, AlertCircle, CheckCircle } from 'lucide-react';
...
const SignupPage: React.FC<SignupPageProps> = ({ onNavigate }) => {
  ...
  const validateForm = () => {
    ...
    if (!formData.fullName.trim()) {
      ...
      newErrors.fullName = 'نام باید حداقل ۲ کاراکتر باشد';
    }
    ...
    if (!formData.profession) {
      newErrors.profession = 'انتخاب رشته/شغل الزامی است';
    }
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-md mx-auto text-center">
            <div className="backdrop-blur-xl bg-white/95 rounded-3xl p-8 border border-white/60 shadow-3xl">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">ثبت نام موفق!</h2>
              <p className="text-gray-600 mb-4">حساب شما با موفقیت ایجاد شد</p>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 pl-12 border-2 rounded-xl focus:ring-2 focus:ring-red-500 transition-all bg-white/80 backdrop-blur-sm hover:border-gray-300 focus:bg-white ${
                      errors.fullName ? 'border-red-300 focus:border-red-500' : 'border-gray-200 focus:border-red-500'
                    }`}
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 pl-12 border-2 rounded-xl focus:ring-2 focus:ring-red-500 transition-all bg-white/80 backdrop-blur-sm hover:border-gray-300 focus:bg-white ${
                      errors.phone ? 'border-red-300 focus:border-red-500' : 'border-gray-200 focus:border-red-500'
                    }`}
              ...
              <div>
                ...
                <div className="relative">
                  <select 
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 pl-12 border-2 rounded-xl focus:ring-2 focus:ring-red-500 transition-all bg-white/80 backdrop-blur-sm hover:border-gray-300 focus:bg-white ${
                      errors.profession ? 'border-red-300 focus:border-red-500' : 'border-gray-200 focus:border-red-500'
                    }`}
                  >
                  ...
                  <Briefcase className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400" size={18} />
                </div>
                {errors.profession && (
                  <p className="mt-1 text-sm text-red-600 flex items-center">
                    <AlertCircle size={14} className="ml-1" />
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 pl-12 pr-12 border-2 rounded-xl focus:ring-2 focus:ring-red-500 transition-all bg-white/80 backdrop-blur-sm hover:border-gray-300 focus:bg-white ${
                      errors.confirmPassword ? 'border-red-300 focus:border-red-500' : 'border-gray-200 focus:border-red-500'
                    }`}
              ...
              <div>
                <label className="flex items-start">
                  <input 
                    ...
                    onChange={handleInputChange}
                    className="rounded border-gray-300 text-red-600 focus:ring-red-500 mt-1 w-4 h-4 transition-colors" 
                  />
